...
These measured profiles directly informed the evaluation ranges in the main study. The combined-motion sweep (Fig.~8 of the main paper) spans up to \SI{5}{m/s^2} and \SI{200}{deg/s^2}, matching the upper range observed here, while the single-axis sweeps in Figs.~2 and~4 of the main paper extend beyond the measured peaks to stress-test performance under extreme conditions. The ``Typical acceleration'' annotations in Figs.~2b and~4b of the main paper mark the human-scale region captured by these experiments.
